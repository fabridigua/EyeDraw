...
1. **Eye Detection** and **Threshold Settings**
   ...
   During all the execution the software analyze the input image from the webcam to detect the face and in particular the eyes. Face and eyes detection is made with OpenCV's **[Haar Cascade Detector]**[^1] and then to detect the pupils, a **Blob Detection** is made with the [SimpleBlobDetector].
