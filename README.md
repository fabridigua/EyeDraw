...
1. **Eye Detection** and **Threshold Settings**
   ...
   Face and eyes detection is made with OpenCV's **[Haar Cascade Detector]**<sup>[1](#myfootnote1)</sup>  and then to detect the pupils, a **Blob Detection** is made with the **[SimpleBlobDetector]**.
...
## References
<a name="myfootnote1">1</a>: WILSON, Phillip Ian; FERNANDEZ, John. Facial feature detection using Haar classifiers. *Journal of Computing Sciences in Colleges*, 2006, 21.4: 127-133.